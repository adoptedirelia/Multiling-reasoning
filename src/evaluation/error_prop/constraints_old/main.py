...
from .io_utils import load_constraints, save_results_json, setup_logging
...
def run(config_path: str):
    ...
    for lang in config.dataset.langs:
        ...
        logging.info("Collected results for language=%s", lang)

    save_results_json(config.outputs.results_json, all_results)
    logging.info("Wrote results JSON: %s", config.outputs.results_json)
    logging.info("Done")
